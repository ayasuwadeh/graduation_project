...
class MapCard extends StatefulWidget {
  ...
  final  hotel;
  final ItemDetails hotelDetails;
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: new BoxDecoration(
                                    ...
                                    image: widget.hotelDetails.image !=
                                            'not found'
                                        ? DecorationImage(
                                            fit: BoxFit.cover,
                                            image: NetworkImage(
                                  ...
                                  child: 
                                     Row(children: [
                                      ...
                                      Container(
                                       ...
                                       widget.hotelDetails.url!='not found'?IconButton(
                                         icon: Icon(Icons.link_rounded),
                                         onPressed: () {
                                           _launchInBrowser(widget.hotelDetails.url);
                                  ...
                                  children: [
                                    SizedBox(
                                      width: 12,
                                       ...
                                       StatsWidget(
                                            rate: widget.hotelDetails.rating,
                                          )
                                  ],
                                ),
                              ],
