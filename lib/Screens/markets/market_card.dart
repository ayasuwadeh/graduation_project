...
class MarketCard extends StatelessWidget {
  ...
  MarketCard({Key key, this.market}) : super(key: key);
       ...
       onTap:()
        {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) {
                ...
                return
                  FutureBuilder(
                      future: itemDetailsApi.fetchDetails(market.id),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        market.location.formattedAddress,
                        maxLines: 3,
                        softWrap: true,
                      ...
                      SizedBox(height: 15,),
                      Text(
                        'Distance: ' + market.location.distance.toString(),
                        style: TextStyle(
                            fontSize: 16
                        ),
                      )
